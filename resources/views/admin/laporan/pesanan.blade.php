...
<div class="w-full py-8">
    <div class="flex justify-between">
      ...
      <div>
        <a href="{{route('admin.laporan.pesanan.print')}}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Cetak</a>
      </div>
    </div>
